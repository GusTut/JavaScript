/* RAccordion for TOC
   By Gustut Sharing Center (http://www.gustut.com)
...
function loadtoc(a){
	...
	tocLoaded=true;
	displayToc2();
	document.write('<a href="http://www.gustut.com" style="font-size: 9px; text-decoration:none; color: #ff3300;"><i>By: Gustut</i></a>')}
...
function displayToc2(){
	...
	while(b<postTitle.length){
		temp1=postLabels[b];
		document.write('<div class="sitemap"><a href="/search/label/'+temp1+'">'+temp1+"</a></div><ol>");
		firsti=a;
		do{
			document.write("<li>");
			document.write('<a href="'+postUrl[a]+'">'+postTitle[a]+"</a>");
			if(postBaru[a]==true){
				document.write(' - <span style="color: red; font-size: 11px;"><i>New !!!</i></span> ')}
			document.write("</li>");
			a=a+1}
